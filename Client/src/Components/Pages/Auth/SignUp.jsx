...
const SignUp = () => {
  ...
  const handleSubmit = async(e) => {
   ...
   const Valid= await SignUpApi(formData,nav);
   if(!Valid){
    seterr(true)
   }
  };
  ...
  return (
    ...
    <div className="max-w-md w-full p-6 space-y-8 bg-primaryDark  rounded-md">
      <div>
        ...
        {err &&<h1 className='text-[16px] pt-3 font-extrabold text-center text-primarylight'>Try Different Email or Username !!</h1>}
      </div>
